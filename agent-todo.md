...
- [ ] Extend fresh tuple/struct-variant payload elimination beyond nested aggregate bindings, constructor-resolved alternatives, and constructor-disjoint preceding arms to guards and wildcard/binding arm proofs; boxes and exact-flow trait objects are eliminated.
