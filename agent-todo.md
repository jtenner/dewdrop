...
- [ ] Broaden local lifetime coalescing beyond immutable sole-use direct aliases and add deeper enum payload-load CSE; exact nested immutable struct-reference extraction CSE is implemented.
