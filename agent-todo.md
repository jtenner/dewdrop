...
- [ ] Extend fresh tuple/struct-variant payload elimination beyond nested aggregate bindings, constructor-resolved alternatives, exact constant guards, false catchall interception proofs, and constructor-disjoint preceding arms to true catchall selection and nonconstant guard planning; boxes and exact-flow trait objects are eliminated.
