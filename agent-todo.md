...
- [x] Extend scalar replacement beyond fresh `if`/match joins and complete/reordered/one-missing component aliases to direct multi-missing and mixed alias/direct aggregates with synthesized scalar and exact nominal-reference component locals; erased-generic component planning remains conservative.
