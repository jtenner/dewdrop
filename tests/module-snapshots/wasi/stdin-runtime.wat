(module
  ...
  (type (;10;) (func (param i32 eqref) (result i32)))
  ...
  (func (;2;) (type 10) (param i32 eqref) (result i32)
  ...
  (func (;3;) (type 11) (param i32 i32) (result eqref)
    (local (ref 13) i32 i32 i32 i32 i32 i32 i32 (ref 13) i32 i32 i32 i32 v128 v128)
    local.get 1
    i32.const 65520
    i32.gt_u
