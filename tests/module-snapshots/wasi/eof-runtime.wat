(module
  ...
  (import "wasi_snapshot_preview1" "fd_read" (func (;1;) (type 3)))
  (memory (;0;) 1)
  (export "main" (func 6))
  ...
  (func (;5;) (type 5) (param i32 i32) (result eqref)
    (local (ref 7) i32 i32 i32 i32 i32 i32 i32 (ref 7) i32 i32 i32 i32 v128 v128)
    local.get 1
    i32.const 65520
    i32.gt_u
