(module
  ...
  (type (;56;) (struct (field (mut eqref)) (field (mut i32)) (field (mut i32))))
  (type (;57;) (struct (field eqref) (field (mut i32))))
  (type (;58;) (sub (struct (field funcref))))
  (type (;59;) (func (param eqref) (result eqref)))
  (type (;60;) (func (param eqref i32) (result eqref)))
  (type (;61;) (func (param eqref) (result (ref 56))))
  ...
  (type (;68;) (func (param eqref eqref) (result (ref 56))))
