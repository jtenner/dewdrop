(module
  ...
  (type (;30;) (func (result (ref 0))))
  (type (;31;) (func (param i32) (result (ref 2))))
  (type (;32;) (func (param i32) (result (ref 2))))
  ...
  (func (;4;) (type 18) (param i32 i32 eqref)
    local.get 0
    local.get 1
    i32.eq
    local.get 2
  ...
  (func (;5;) (type 19) (param i32 i32 eqref)
    local.get 0
    local.get 1
    i32.eq
    i32.eqz
  ...
  (func (;6;) (type 20) (param i32 i32 eqref)
    local.get 0
    local.get 1
    i32.lt_s
    local.get 2
  ...
  (func (;7;) (type 21) (param i32 i32 eqref)
    local.get 0
    local.get 1
    i32.le_s
    local.get 2
  ...
  (func (;8;) (type 22) (param i32 i32 eqref)
    local.get 0
    local.get 1
    i32.gt_s
    local.get 2
  ...
  (func (;9;) (type 23) (param i32 i32 eqref)
    local.get 0
    local.get 1
    i32.ge_s
    local.get 2
  ...
  (func (;10;) (type 24) (param (ref 0) eqref)
    (local eqref)
    local.get 0
    local.set 2
    block ;; label = @1
  ...
  (func (;11;) (type 25) (param (ref 0) eqref)
    (local eqref)
    local.get 0
    local.set 2
    block ;; label = @1
  ...
  (func (;12;) (type 26) (param (ref 2) eqref)
    (local eqref)
    local.get 0
    local.set 2
    block ;; label = @1
  ...
  (func (;13;) (type 27) (param (ref 2) eqref)
    (local eqref)
    local.get 0
    local.set 2
    block ;; label = @1
  ...
  (func (;14;) (type 29) (param i32 eqref) (result i32)
    (local (ref 36) (ref 34) i32 i32 i32 i32 i32 i32 i32 v128 i32 i32)
    local.get 1
    ref.cast (ref 36)
    local.set 2
    local.get 2
  ...
  (func (;15;) (type 30) (result (ref 0))
    i32.const 0
    struct.new 0
    ref.cast (ref 0)
  )
  (func (;16;) (type 31) (param i32) (result (ref 2))
    i32.const 0
    local.get 0
    i64.const 0
    f32.const 0x0p+0 (;=0;)
  ...
  (func (;17;) (type 32) (param i32) (result (ref 2))
    i32.const 1
    local.get 0
    i64.const 0
    f32.const 0x0p+0 (;=0;)
