(module
  ...
  (type (;2;) (struct (field i32) (field i32)))
  (type (;3;) (struct (field (mut i32))))
  (type (;4;) (func (result (ref 0))))
  (type (;5;) (func (param eqref) (result (ref 0))))
  ...
  (export "main" (func 1))
  (func (;0;) (type 6) (param i32) (result (ref 0))
    local.get 0
    i32.const 42
    i32.eq
  ...
  (func (;1;) (type 7)
    (local (ref 2) i32 i32 i32 i32 eqref i32 i32 i32 i32 i32 i32 eqref i32 eqref eqref eqref i32 eqref i32 eqref i32 eqref i32 eqref eqref)
    i32.const 42
    local.set 8
    block ;; label = @1
      local.get 8
  ...
  (func (;2;) (type 5) (param eqref) (result (ref 0))
    local.get 0
    ref.cast (ref 3)
    local.get 0
    ref.cast (ref 3)
