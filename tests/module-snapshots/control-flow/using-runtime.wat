(module
  ...
  (func (;4;) (type 31) (param (ref 26))
    local.get 0
    struct.get 26 0
    call 2
  )
  (func (;5;) (type 32) (param i32) (result (ref 26))
    i32.const 1
    call 2
    local.get 0
    struct.new 26
  ...
  (func (;7;) (type 33) (result i32)
    i32.const 4
    call 2
    i32.const 9
  )
  (func (;8;) (type 34) (result i32)
    (local (ref 26) i32)
    i32.const 5
    call 5
    local.set 0
  ...
  (func (;9;) (type 35) (param (ref 26)) (result i32)
    i32.const 7
    call 2
    local.get 0
    struct.get 26 0
  ...
  (func (;10;) (type 36) (result i32)
    (local i32 (ref 26) i32 i32 i32)
    i32.const 0
    local.set 3
    block ;; label = @1
      loop ;; label = @2
  ...
  (func (;11;) (type 37) (result i32)
    (local i32 (ref 26) i32 i32 i32 i32)
    i32.const 0
    local.set 4
    block ;; label = @1
      loop ;; label = @2
  ...
  (func (;17;) (type 14) (param eqref)
    local.get 0
    ref.cast (ref 26)
    call 4
  )
  (func (;18;) (type 14) (param eqref)
    local.get 0
    ref.cast (ref 26)
    call 4
  )
  (func (;19;) (type 14) (param eqref)
    local.get 0
    ref.cast (ref 26)
    call 4
  )
