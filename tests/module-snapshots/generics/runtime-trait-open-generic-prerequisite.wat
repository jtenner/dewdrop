(module
  ...
  (memory (;0;) 1)
  (global (;0;) (mut (ref null 6)) ref.null 6)
  (export "main" (func 6))
  (export "__dew_init" (func 10))
  (export "memory" (memory 0))
  (elem (;0;) declare func 9)
  ...
  (func (;4;) (type 8) (param i32) (result i32)
    local.get 0
  )
  ...
  (func (;6;) (type 12) (result i32)
    ...
    v128.const i32x4 0x2d636972 0x72657270 0x69757165 0x65746973
  ...
  (func (;7;) (type 13) (param i32 eqref) (result eqref)
    local.get 0
  ...
  (func (;9;) (type 5) (param eqref) (result i32)
    local.get 0
    ref.cast (ref 4)
    call 8
  )
