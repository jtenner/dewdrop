(module
  ...
  (type (;114;) (func (param (ref 6) eqref) (result (ref 1))))
  ...
  (func (;93;) (type 114) (param (ref 6) eqref) (result (ref 1))
    (local i32 (ref 56) eqref i32 eqref i32 eqref)
    i32.const 0
    local.set 7
    block ;; label = @1
      loop ;; label = @2
