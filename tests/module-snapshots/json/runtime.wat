(module
  ...
  (type (;126;) (func (param (ref 6) eqref) (result (ref 1))))
  ...
  (func (;100;) (type 126) (param (ref 6) eqref) (result (ref 1))
    (local i32 (ref 62) eqref i32 eqref i32 eqref)
    i32.const 0
    local.set 7
    block ;; label = @1
      loop ;; label = @2
