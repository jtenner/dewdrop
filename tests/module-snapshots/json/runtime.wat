(module
  ...
  (type (;156;) (func (param (ref 19) eqref) (result (ref 9))))
  ...
  (func (;100;) (type 156) (param (ref 19) eqref) (result (ref 9))
    (local i32 (ref 92) eqref i32 eqref i32 eqref)
    i32.const 0
    local.set 7
    block ;; label = @1
      loop ;; label = @2
