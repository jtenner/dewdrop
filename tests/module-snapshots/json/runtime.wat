(module
  ...
  (type (;150;) (func (param (ref 14) eqref) (result (ref 9))))
  ...
  (func (;100;) (type 150) (param (ref 14) eqref) (result (ref 9))
    (local i32 (ref 86) eqref i32 eqref i32 eqref)
    i32.const 0
    local.set 7
    block ;; label = @1
      loop ;; label = @2
