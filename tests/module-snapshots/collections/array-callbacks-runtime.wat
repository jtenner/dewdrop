(module
  ...
  (type (;30;) (func (param (ref 0) eqref)))
  (type (;31;) (func (param (ref 0) eqref)))
  (type (;32;) (func (param (ref 0) eqref)))
  ...
  (type (;37;) (func (param eqref i32 i32)))
  ...
  (func (;3;) (type 32) (param (ref 0) eqref)
    (local i32 i32 eqref i32 eqref eqref i32)
    local.get 0
    ref.cast (ref 0)
    struct.get 0 1
  ...
  (func (;4;) (type 34) (param i32 eqref) (result i32)
    (local (ref 43) (ref 41) i32 i32 i32 i32 i32 i32 i32 v128 i32 i32)
    local.get 1
    ref.cast (ref 43)
    local.set 2
    local.get 2
  ...
  (func (;9;) (type 37) (param eqref i32 i32)
