(module
  ...
  (func (;5;) (type 5) (param i32) (result i64)
    local.get 0
    call 1
  )
  ...
  (func (;9;) (type 9) (param i64 i32) (result i32)
    local.get 0
    local.get 1
    call 6
  )
  ...
  (func (;11;) (type 11) (param i64 i64) (result i64)
    local.get 0
    local.get 1
    call 7
  )
  (func (;12;) (type 12) (result i32)
    ...
    if (result i32) ;; label = @1
      i32.const 1
      v128.const i32x4 0x656e616c 0x38693a73 0x612d3878 0x68746972
      v128.const i32x4 0x6974656d 0x00000063 0x00000000 0x00000000
