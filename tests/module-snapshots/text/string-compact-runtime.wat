(module
  ...
  (type (;3;) (func (param i32) (result eqref)))
  ...
  (func (;2;) (type 1) (param eqref i32 i32) (result eqref)
    (local (ref 14) (ref 13) i32 i32 i32 i32)
    local.get 0
    ref.cast (ref 14)
    local.set 3
    local.get 3
  ...
  (func (;3;) (type 2) (param eqref) (result i32)
    local.get 0
    ref.cast (ref 16)
    struct.get 16 2
  )
  (func (;4;) (type 3) (param i32) (result eqref)
    local.get 0
    i32.const 4
    i32.shr_u
    local.get 0
  ...
  (func (;5;) (type 4) (param eqref eqref)
    (local (ref 17) (ref 16) (ref 13) (ref 13) i32 i32 i32 i32 i32 i32 (ref 13) i32 i32 i32 i32 i32 v128 v128)
    local.get 0
    ref.cast (ref 17)
    local.set 2
    local.get 2
  ...
  (func (;6;) (type 5) (param eqref) (result eqref)
    (local (ref 17))
    local.get 0
    ref.cast (ref 17)
    local.set 1
  ...
  (func (;8;) (type 7) (param eqref i32 i32) (result eqref)
    local.get 0
    local.get 1
    local.get 2
    call 2
  )
  (func (;9;) (type 8) (param eqref) (result i32)
    local.get 0
    call 3
  )
  (func (;10;) (type 9) (param eqref) (result eqref)
    (local eqref)
    local.get 0
    call 9
    call 4
  ...
  (func (;11;) (type 11) (param i32 eqref) (result i32)
