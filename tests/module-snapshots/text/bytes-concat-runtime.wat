(module
  (type (;0;) (func (param eqref eqref) (result eqref)))
  ...
  (func (;1;) (type 0) (param eqref eqref) (result eqref)
    (local (ref 7) (ref 7) (ref 5) (ref 5) (ref 5) i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 v128 v128)
    local.get 0
    ref.cast (ref 7)
    local.set 2
    local.get 1
  ...
  (func (;3;) (type 3) (param i32 eqref) (result i32)
    (local (ref 7) (ref 5) i32 i32 i32 i32 i32 i32 i32 v128 i32 i32)
    local.get 1
    ref.cast (ref 7)
    local.set 2
    local.get 2
  ...
  (func (;4;) (type 4) (result i32)
    i32.const 1
    v128.const i32x4 0x65747962 0x00002d73 0x00000000 0x00000000
    array.new_fixed 5 1
    i32.const 0
    i32.const 6
    struct.new 7
    v128.const i32x4 0x636e6f63 0x00007461 0x00000000 0x00000000
    array.new_fixed 5 1
    i32.const 0
    i32.const 6
    struct.new 7
