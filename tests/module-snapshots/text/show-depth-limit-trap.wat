(module
  ...
  (type (;43;) (func (param (ref 37) eqref)))
  (type (;44;) (func (param eqref) (result eqref)))
  (type (;45;) (sub (struct (field i32))))
  (type (;46;) (sub final 45 (struct (field i32) (field (ref 45)))))
  (type (;47;) (func (param (ref 45) (ref 37))))
  (type (;48;) (func (param i32) (result (ref 45))))
  (type (;49;) (func))
  (type (;50;) (struct (field (mut eqref)) (field (mut i32))))
  (type (;51;) (struct))
  (type (;52;) (struct (field (mut eqref)) (field (mut i32))))
  (type (;53;) (struct (field (mut eqref)) (field (mut i32))))
  (type (;54;) (struct (field (mut eqref)) (field (mut i32))))
  ...
  (func (;13;) (type 43) (param (ref 37) eqref)
    local.get 0
    ref.cast (ref 37)
    call 11
    local.get 1
  ...
  (func (;14;) (type 44) (param eqref) (result eqref)
    (local eqref)
    call 6
    local.set 1
    local.get 1
  ...
  (func (;15;) (type 47) (param (ref 45) (ref 37))
    (local (ref 45) eqref)
    local.get 0
    local.set 3
    block ;; label = @1
  ...
  (func (;16;) (type 48) (param i32) (result (ref 45))
    local.get 0
    i32.const 0
    i32.eq
