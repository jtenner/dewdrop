...
data Lanes = Lanes16 Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int
...
data RefType = RefType HeapType Boolean
             | RefTypeAny
             | RefTypeEq
             | RefTypeI31
             | RefTypeStruct
...
data StorageType = StorageTypeValType ValType
                 | StorageTypeI8
                 | StorageTypeI16
...
data CompositeType = CompositeTypeFunc FuncType
                   | CompositeTypeStruct StructType
                   | CompositeTypeArray ArrayType

data SubType = SubType (FingerTree TypeIndex) CompositeType
...
data ExternType = ExternTypeFunc DefType
...
data ImportKind = ImportKindFunc TypeIndex
...
data ExportKind = ExportKindFunc FuncIndex
...
encode_string v s =
  ...
  in Array.foldl (flip encode_char) s' chars
