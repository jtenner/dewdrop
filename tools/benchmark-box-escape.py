#!/usr/bin/env python3
"""Benchmark nonescaping single-field reference-box elimination."""
...
TMP = ROOT / ".tmp" / "box-escape-benchmark"

OPTIMIZED = """struct Token {
  value: I32
}
