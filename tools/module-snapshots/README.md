...
The suite contains 161 fixtures:
...
Eighty-nine compiled fixtures assert nonempty stdout, twelve assert normalized
...
As of August 2, 2026, all 143 compiled fixtures pass in Node. The module
initialization/import fixtures passed targeted Wago `CoreFeaturesV3` validation,
but full Wago parity is temporarily blocked by unrelated uncommitted build
failures in the actively modified sibling Wago checkout.
...
static multi-module linking, and explicit test-mode execution.
