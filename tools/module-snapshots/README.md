...
The suite contains 178 fixtures:
...
runtime traps, and fifty-four intentionally remain WAT/no-trap fixtures. The
...
As of August 3, 2026, all 157 compiled fixtures pass in Node, including generic
parameter-selector/callback specialization, module
