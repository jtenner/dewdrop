...
The suite contains 181 fixtures:
...
runtime traps, and fifty-seven intentionally remain WAT/no-trap fixtures. The
...
As of August 3, 2026, all 160 compiled fixtures pass in Node, including generic
