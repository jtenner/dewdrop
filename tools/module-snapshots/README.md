...
The suite contains 184 fixtures:
...
runtime traps, and sixty intentionally remain WAT/no-trap fixtures. The
...
As of August 3, 2026, all 163 compiled fixtures pass in Node, including root-exported erased generic fallbacks, exact nominal-reference adapters, generic structs, nested/multi-parameter generic ABI closure, generic
