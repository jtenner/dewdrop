...
- [x] Coalesce immutable uncaptured sole-use direct local aliases into their exact source local when type, carrier, and nominal evidence match, preserving initialization and rejecting shared-source or mutable snapshot cases.
