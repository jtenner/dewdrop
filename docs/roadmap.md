...
- 219 deterministic compiler fixtures organized by language/runtime feature across calls, collections, control flow, enums, functions, generics, lanes, memory, modules, names, numeric operations, reachability, structs, tests, text, types, and WASI: 185 compiled WAT/runtime snapshots plus 34 compiler-error snapshots.
...
- [x] Establish broad feature-oriented coverage with 219 fixtures: 185 compiled WAT/runtime snapshots and 34 compiler-error snapshots; every compiled fixture requires identical Node/Wago Core 3 output and traps.
