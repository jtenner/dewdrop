...
1. Finish the bounded optimization program with follow-up private enum signature/payload specialization; broader control-flow local coloring remains measurement-driven future work.
