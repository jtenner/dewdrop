...
- [ ] Extend direct and let-bound fresh tuple-variant payload elimination to struct variants, nested patterns, guarded cases, and broader arm-order proofs; nonescaping singleton boxes and exact-flow trait objects already eliminate wrappers and dispatch artifacts.
