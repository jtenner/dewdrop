...
- [ ] Extend scalar replacement to control-flow joins and distinct-field uses with component-local planning; repeated reads of one scalar field now reuse the aggregate's existing local and remove the allocation.
