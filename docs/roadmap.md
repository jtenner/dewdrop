...
- [ ] Extend direct and let-bound fresh tuple/struct-variant payload elimination to nested patterns, guarded cases, and broader arm-order proofs; nonescaping singleton boxes and exact-flow trait objects already eliminate wrappers and dispatch artifacts.
