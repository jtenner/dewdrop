...
is prerequisite and generic-bound evidence trees, module-value graph import
into independent function solvers, and lambda-family inference. Module-value
dependency SCC scheduling, shared-SCC inference, and successful basic body
result compaction are complete.
...
1. Complete body inference: prerequisite evidence trees, frozen module-value graph import into function solvers, lambda families, and final deterministic result merging.
