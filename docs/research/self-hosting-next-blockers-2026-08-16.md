...
2. Complete alternative-pattern flow coverage and invalid-pattern suppression, then port layouts, specialization, optimization, and backend phases in dependency order.
