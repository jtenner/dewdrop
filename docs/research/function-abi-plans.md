...
5. Make instantiated generic aggregate callback fields directly callable from Dew so runtime fixtures can exercise reconstructed callback payloads without a separate package consumer.
