...
1. Replace acyclic nominal-cycle rejection with cyclic graph helpers, then synthesize structural callback wrapper closures. Function-containing and cyclic export adapters remain conservatively excluded until those helpers exist.
