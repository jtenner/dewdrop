...
1. Extend callback and runtime-trait effect/escape summaries across non-transparent public APIs and remove unused signature/closure-entry types after directization.
