...
both shared execution lanes. The later call-index batch passes clean bootstrap
in 182.686 seconds with identical B/C bytes; see its
[validation log](linked-call-index-contracts-2026-09-09.md).
