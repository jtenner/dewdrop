...
These host-sensitive reruns show that context-sensitive eligibility analysis, call-site evidence spans, imported trait-use collection, and prerequisite-bearing implementation-method specialization remain below 4 ms on the measured workload; they are directional rather than stable performance guarantees.
