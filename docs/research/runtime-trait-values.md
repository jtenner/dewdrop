...
- external runtime-evidence forwarding through two generic calls: `3.13–3.58 ms`.

These host-sensitive reruns show that transitive eligibility analysis, call-site evidence spans, and imported trait-use collection remain below 4 ms on the measured workload; they are directional rather than stable performance guarantees.
