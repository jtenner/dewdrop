...
| retained direct aggregate | 0.0176 µs | 1 | 16 | 783 |
| synthesized nominal references | 0.0145 µs | 2 | 2 | 482 |
| retained outer reference aggregate | 0.0155 µs | 3 | 4 | 517 |

Scalar forms were effectively tied within timer noise. Source-local component reuse removed 380–384 Wasm bytes; synthesized direct scalars removed 154 bytes, one allocation, and 16 field reads. Exact nominal-reference splitting measured 0.9356x its retained baseline and removed the outer aggregate allocation, two outer field reads, and 35 Wasm bytes while retaining both inner objects.
