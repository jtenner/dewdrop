...
| Object constructor fields retain exact identities and source evaluation order | Checked and tested; complete recipe freeze and nominal recovery remain open | `semantic_constructor_field_recipes.dew`, `starshine_module.dew` | `../research/constructor-field-identity-2026-09-08.md` |
