...
- Versioned `dew.metrics` Wasm metadata and deterministic static budgets for specialization, adapter, allocation-site, dispatch, cast, and output-size costs.
