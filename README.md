...
- Explicit `dew.std.encoding.utf8` zero-copy encoding, strict decoding with malformed byte offsets, and deterministic lossy decoding.
...
- Standard `dew.std.encode` and `dew.std.decode` evidence, bounded Semantic Versioning 2.0.0, and deterministic fallible codecs for `dew.json`, `dew.lock`, `dew.modules.json`, and installed-package capsules.
